...
# 配置
ROOT_DIR = "NQ100"
OUTPUT_FILE = "NQ100_T_Shape_Structure.docx"
...
def main():
    ...
    for problem_dir in valid_dirs:
        ...
        cpp_file = None
        candidates_cpp = [
            os.path.join(full_path, f"{problem_dir}_improved.cpp"),
            os.path.join(full_path, "cpp_compressed.cpp"),
            os.path.join(full_path, f"{problem_dir}.cpp"),
        ...
        py_file = None
        candidates_py = [
            os.path.join(full_path, f"{problem_dir}_improved.py"),
