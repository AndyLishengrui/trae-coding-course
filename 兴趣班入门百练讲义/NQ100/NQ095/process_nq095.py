#!/usr/bin/env python3
"""
Script to process NQ095 using textbook-code-optimizer skill
"""
import os

# Paths
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
CPP_FILE = os.path.join(BASE_DIR, "NQ095_improved.cpp")
PY_FILE = os.path.join(BASE_DIR, "NQ095_improved.py")

# Function to call textbook-code-optimizer skill
def optimize_code():
    """Optimize C++ code and generate Python equivalent, 思路, and DOCX"""
    print("Processing NQ095 with textbook-code-optimizer...")
