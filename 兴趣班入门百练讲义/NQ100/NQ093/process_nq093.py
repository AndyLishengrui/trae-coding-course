#!/usr/bin/env python3
"""
Script to process NQ093 using textbook-code-optimizer skill
"""
import os
import json
...
CPP_FILE = os.path.join(BASE_DIR, "NQ093_improved.cpp")
PY_FILE = os.path.join(BASE_DIR, "NQ093_improved.py")

# Function to call textbook-code-optimizer skill
def optimize_code():
    """Optimize C++ code and generate Python equivalent, 思路, and DOCX"""
    print("Processing NQ093 with textbook-code-optimizer...")
